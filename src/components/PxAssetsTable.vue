  ...
  <table>
    <thead>
      <tr class="bg-gray-100 border-b-2 border-gray-400">
        ...
        <td class="hidden sm:block">
          <input
           class="bg-gray-100 focus:outline-none border-b border-gray-400 py-2 px-2 block rounded"
           type="text"  id="filter" placeholder="Buscar ..."
           v-model="filter" />
        </td>
      </tr>
    </thead>
    <tbody>
      ...
      v-for="a in filteredAssets" :key="a.id">
        ...
        <td class="hidden sm:block">
          <px-button @custom-click="goToCoind(a.id)">
            <span>Detalle</span>
          </px-button>
        </td>
      </tr>
